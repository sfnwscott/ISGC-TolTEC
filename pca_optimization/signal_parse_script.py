...
neigs, obs_name, offsets_y, offsets_x, peaks_S = [], [], [], [], []
full_path = 'redu02/coaddedraw/toltec_commissioning_a1100_citlali.fits'
...
pointing_offsets = QTable([neigs, peaks_S, obs_name, offsets_x, offsets_y], 
                          names=('N-eig', 'Peak S', 'Obs', 'x Offset', 'y Offset'))
pointing_offsets.pprint_all()
pointing_offsets.write('signal_table.csv', format='ascii.csv', overwrite=True)
