...
# read in offsets
signal_table = pd.read_csv('signal_table_full3eig.csv')

def cut_ell(map, ell_cutoff):
...
#        path_obs = './fits_files/new/signal_comp_2/redu00_3evals/toltec_commissioning_a1100_science_' + str(obs) + '_citlali.fits'
        ...
        for ell_cutoff in [0,1,2,3,4,5,6]:
...
ell_table.to_csv('ell_cutoff_signal_table.csv')
